...
<table border="1" cellspacing="0" rules="1" width="1000">
    <tr>
        <td colspan="12"><a href="/index.php/Admin/Doc/charts">统计</a></td>
    </tr>
    <tr class="s">
        <td>序号</td>
        <td>标题</td>
    ...
    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td title="<?php echo ($vol["title"]); ?>"><?php echo (msubstr($vol["title"],0,8)); ?></td>
            <td>
                <?php if(!empty($vol["filename"])): ?><a href="/index.php/Admin/Doc/file_download/id/<?php echo ($vol["id"]); ?>" ><?php echo ($vol["filename"]); ?></a><?php endif; ?>
            </td>
            <td><?php echo ($vol["author"]); ?></td>
            <td><?php echo (date('Y-m-d H:i:s',$vol["addtime"])); ?></td>
            <td>
                <a href="javascript:;" class="show" data="<?php echo ($vol["id"]); ?>" data2="<?php echo ($vol["title"]); ?>">查看</a>
                |
...
//        console.log(id);
    ...
    $('.show').on('click',function () {
        ...
        layer.open({
            ...
            shade:0.3,//设置背景
            area:['600px','90%'],
            content:'/index.php/Admin/Doc/showContent/id/' + id //iframe 的URL
        });
    });
</script>
</html>